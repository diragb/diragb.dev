      ...
      <div className='flex flex-col gap-1 sm:gap-2 w-full'>
        <div className='flex flex-col w-full'>
          <div className='flex items-start sm:items-center justify-start sm:justify-between flex-col sm:flex-row w-full'>
            <div
              className='text-xl sm:text-2xl leading-[31px] text-zinc-950'
              style={{
          ...
          <Link href={company.URL} target='_blank' className='w-fit text-sm sm:text-base leading-[21px] text-zinc-700 transition-all hover:text-teal-600'>{company.name}</Link>
        </div>
        <div className='text-lg sm:text-xl leading-[26px] text-zinc-800'>
          {description}
        </div>
