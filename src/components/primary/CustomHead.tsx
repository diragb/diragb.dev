...
const CustomHead = ({
  ...
  <Head>
    ...
    <meta name='image' content='https://diragb.dev/square-cover.jpg' />
    ...
    <meta property='og:image' content='https://diragb.dev/square-cover.jpg' />
    ...
    <meta name='twitter:image' content='https://diragb.dev/rect-cover.jpg' />
